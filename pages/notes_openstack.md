...
```
Show which actions has taken on the server, actions history
```
...
```
List volume back up for a given volume

```
openstack volume backup list --all-projects --volume <vol-id>
```
